...
- **URL de producción:** Pendiente de publicación en Vercel desde esta sesión
...
- Manejo global de 403 para cliente con redirección silenciosa a `/my-reservations` cuando accede a una ruta restringida.
...
- Mensajes 409 de negocio alineados a operación hotelera:
	- Solapamiento: habitación y fechas del conflicto.
	- Eliminación de habitación con reservas activas.
	- Correo y documento duplicados con textos diferenciados.
...
- En frontend se conserva Pages Router para rutas administrativas, evitando conflicto de build con App Router en las mismas rutas.
...
- `backend npm run lint`: con errores preexistentes de configuración ESLint y reglas no encontradas (fuera del alcance de esta fase de cierre funcional).
- Proyecto cerrado funcionalmente dentro de esta sesión, pendiente únicamente de publicar URL de producción.